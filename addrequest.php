            ...
            <div id="content">
                ...
                <div class="addkit">
                    <div class="container-md">
                        <div class="row">
                            <div class="col"></div>
                            <div class="col text-center"><span><h2>Request Exatron Kit</h2></span></div>
                            <div class="col"></div>
                        </div>
                    </div>
                    ...
                    <div class="container-md text-center">
                        <form action="query.php" method="POST">
                            <input type="text" id="act" name="act" value="kitrequest" hidden>
                            <div class="row">
                                <div class="col">
                                    <input class="form-control" type="text" id="barcode" name="barcode" placeholder="Barcode"><br>

                                    <input class="form-control" type="text" id="kitname" name="kitname" placeholder="Kit Name"><br>

                                    <input class="form-control" type="text" id="location" name="location" placeholder="Location"><br>

                                    <input class="form-control" type="text" id="remarks" name="remarks" placeholder="Remarks"><br>
                                
                                    <button class="btn btn-primary mb-3">Send Request</button>
                                </div>
                            </div>
                        </form>
                    </div>
